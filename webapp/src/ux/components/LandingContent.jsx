...
class LandingContent extends React.Component {
  ...
  render = () => {
    ...
    let translateMap = {
      ...
      'send': {
        'translate':(this.context.action === 'send') ? 0: 200,
        'opacity':(this.context.action === 'send') ? 1: 0,
      },
    }
    ...
    return (
      <ContentContainer>
        ...
        <ActionContainer translate={this.state.translateAction}>
          ...
          <ActionPage translate={translateMap['send']['translate']} opacity={translateMap['send']['opacity']}>
            <Send/>
          </ActionPage>
        </ActionContainer>
      </ContentContainer>
